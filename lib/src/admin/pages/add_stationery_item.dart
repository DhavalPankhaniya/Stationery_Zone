...
import 'package:flutter_stationery_zone/src/models/item_model.dart';
import 'package:flutter_stationery_zone/src/scoped-model/main_model.dart';
import 'package:flutter_stationery_zone/src/widgets/button.dart';
import 'package:flutter_stationery_zone/src/widgets/show_dailog.dart';
...
class _AddFoodItemState extends State<AddFoodItem> {
    ...
    if (_foodItemFormKey.currentState.validate()) {
      ...
      if (widget.food != null) {
        ...
        if (value) {
          Navigator.of(context).pop();
          SnackBar snackBar =
              SnackBar(content: Text("Stationery item successfully added."));
          _scaffoldStateKey.currentState.showSnackBar(snackBar);
        } else if (!value) {
          Navigator.of(context).pop();
          SnackBar snackBar =
              SnackBar(content: Text("Failed to add Stationery item"));
          _scaffoldStateKey.currentState.showSnackBar(snackBar);
        }
      }
    }
  ...
  Widget _buildTextFormField(String hint, {int maxLine = 1}) {
    return TextFormField(
      initialValue: widget.food != null && hint == "Title"
          ? widget.food.name
      ...
      validator: (String value) {
        ...
        if (value.isEmpty && hint == "Title") {
          return "The Stationery title is required";
        }
